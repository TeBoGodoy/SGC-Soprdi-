<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="COMISIONES_REGLA.aspx.cs" Inherits="SoprodiApp.COMISIONES_REGLA" %>
   ...
   <%-- <div class="page-title" style="margin-top: -27px">
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb" style="height: 40px !important;">
            ...
            <li class="active">Reglas para comisiones</li>
        </ul>
    </div>
    ...
    <div id="main-content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i>Reglas para comisiones</h3>
                    </div>
                    <div class="box-content">
                        ...
                        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                            <ContentTemplate>                                
                                <div class="row"> 
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="T_ID_REGLA" Visible="false"></asp:TextBox>
                                            <label class="col-sm-2 control-label">
                                                <b>Código</b>
                                            </label>
                                            <div class="col-sm-3 controls">
                                                <asp:TextBox runat="server" ID="T_COD_COMISION" CssClass="form-control input-sm" Enabled="false"></asp:TextBox>
                                            </div>
                                            <label class="col-sm-2 control-label">
                                                <b>Nombre</b>
                                            </label>
                                            <div class="col-sm-3 controls">
                                                <asp:TextBox runat="server" ID="T_NOM_COMISION" CssClass="form-control input-sm" Enabled="false"></asp:TextBox>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView CssClass="table fill-head table-bordered filtrar" ID="G_Banco" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True" Width="100%" OnRowCommand="G_Banco_RowCommand" DataKeyNames="id_comision, COD_COMISION, NOMBRE_COMISION">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="id" DataField="id_COMISION" Visible="false" />
                                                <asp:BoundField HeaderText="Codigo" DataField="COD_COMISION" />
                                                <asp:BoundField HeaderText="Nombre" DataField="NOMBRE_COMISION" />
                                            </Columns>
                                            <EmptyDataTemplate>
                                                No existen datos.
                                            </EmptyDataTemplate>
