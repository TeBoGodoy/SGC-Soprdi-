<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_SALDOS_SP.aspx.cs" Inherits="SoprodiApp.REPORTE_SALDOS_SP" %>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12" id="div_superior">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Saldos</h3>
                                <div class="box-tool">
                                                    ...
                                                    <div class="box">
                                                        <div class="form-group" style="overflow: auto">
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_VENDEDOR" ClientIDMode="Static" CssClass="table table-bordered table-advance filtrar" OnRowCommand="G_INFORME_TOTAL_VENDEDOR_RowCommand" OnRowDataBound="G_INFORME_TOTAL_VENDEDOR_RowDataBound" runat="server"
                                                                ...
                                                                DataKeyNames="CodDocumento,FechaEmision,CodVendedor,CodBodega,FechaDespacho, rut"
                                                                Font-Size="12px">
