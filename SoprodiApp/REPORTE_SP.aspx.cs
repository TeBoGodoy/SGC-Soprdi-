...
{
    public partial class REPORTE_SP : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (sw_proviene != "NO")
                {
                    ...
                    if (sw_proviene == "912")
                    {
                        ...
                        Session["WHERE"] += " and b.rut = '" + rutcliente + "' and b.codvendedor = '" + vendedor + "' and b.CodEstadoDocumento in ('20', '10', '40') and m.estado is null ";
                        Session["estados_param"] = "'10S', '10', '10P', '40'";
                    ...
                    else
                    {
                        ...
                        Session["WHERE"] += " and a.codproducto in ('" + cod_prod + "') and b.CodEstadoDocumento in ('20', '10', '40') and b.fechaemision <= convert(datetime, '"+hasta+ "',103) and m.estado is null ";
                        Session["estados_param"] = "'10S', '10', '10P', '40'";
        ...
        protected void G_INFORME_TOTAL_VENDEDOR_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    e.Row.Cells[32].Text = "pendiente";
                }


                if (Session["estado_cerrada"].ToString().Contains((e.Row.Cells[32].Text.Trim())) || Session["estado_cerrada"].ToString() == "")
                {
                    ...
                    //GxDef
                    //10
                    e.Row.Cells[28].Text = e.Row.Cells[28].Text.Trim();

                    if (Session["estados"].ToString().Contains((e.Row.Cells[28].Text)) || Session["estados"].ToString() == "")
                    {
                        //if (e.Row.Cells[27].Text.Trim() == "20" && e.Row.Cells[16].Text.Trim() == "&nbsp;")
                        //{
                        ...
                        if (e.Row.Cells[28].Text.Trim() == "20")
                        {
                            e.Row.Attributes["class"] = "estado20";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "10P")
                        {
                            e.Row.Attributes["class"] = "estado10P";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "10S")
                        {
                            e.Row.Attributes["class"] = "estado10S";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "40")
                        {
                            e.Row.Attributes["class"] = "estado40";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "30")
                        {
                            e.Row.Attributes["class"] = "estado30";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "GxDef")
                        {
                            e.Row.Attributes["class"] = "estadoGFX";
                        }
                        else if (e.Row.Cells[28].Text.Trim() == "10")
                        {
                        ...
                        if (e.Row.Cells[10].Text.Contains("-"))
                        {
                            ...
                            {
                                e.Row.Cells[11].Style.Value = "color:red";
                                e.Row.Cells[10].Style.Value = "color:red";
                            }
                        }
                        ...
                        e.Row.Cells[17].Text = "<a href='REPORTE_LISTADO_DOC.aspx?F=" + e.Row.Cells[17].Text + "' target='_blank'>" + e.Row.Cells[17].Text + " </a> ";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            where3 += " and a.codproducto not in (select distinct(codproducto)  from VPEDIDODETALLE_THX where ISNUMERIC(CodProducto) <> 1) ";
