...
{
    public partial class REPORTE_MATRIZ : System.Web.UI.Page
    {
        ...
        protected void btn_productos_Click(object sender, EventArgs e)
        {
            ...
            DateTime aux_time = new DateTime(desde_año, desde_mes, desde_dia);
            string desde_menos1_mes = aux_time.AddMonths(-1).ToShortDateString();
            ...
            else
            {
                ...
                foreach (DataRow r in productos.Rows)
                {
                    HTML += "<th colspan=1; style='background-color: rgb(220, 220, 220) !important; color:white !important;' >" + r[1].ToString().Trim() + "TOTAL_SIN</th>";
                    HTML += "<th colspan=1; style='background-color: rgb(220, 220, 220) !important; color:white !important;' >" + r[1].ToString().Trim() + "PORTOTAL_</th>";
                    //HTML += "<th colspan=1; style='background-color: rgb(220, 220, 220) !important; color:white !important;' > TOTAL_CLIENTES</th>";
                    //HTML += "<th colspan=1; style='background-color: rgb(220, 220, 220) !important; color:white !important;' > TOTAL_CLIENTES_ANTERIOR</th>";
                ...
                foreach (DataRow r2 in productos.Rows)
                {
                    ...
                    if (SUM_VENTA1 > SUM_VENTA)
                    {
                        ...
                        HTML = HTML.Replace(r2[1].ToString().Trim() + "TOTAL_SIN", "<a style='color:blue'>" + SUM_VENTA1.ToString("N0") +" </a>");
                        HTML = HTML.Replace(r2[1].ToString().Trim() + "PORTOTAL_", "<a style='color:blue'>" + porct + " </a>");
                    }
                    else {

                   
                        HTML = HTML.Replace(r2[1].ToString().Trim() + "TOTAL_SIN", "<a style='color:red'>" + SUM_VENTA1.ToString("N0") + " </a>");
                        HTML = HTML.Replace(r2[1].ToString().Trim() + "PORTOTAL_", "<a style='color:red'>" + porct + " </a>");
                    }
