<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_STOCK.aspx.cs" Inherits="SoprodiApp.REPORTE_STOCK" %>
            ...
            <script type="text/javascript">
                ...
                function BindEvents() {
                    ...
                    $("#<%=d_bodega.ClientID%>").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_STOCK.aspx/PRODUCTO_POR_BODEGA",
                            data: parameters,
