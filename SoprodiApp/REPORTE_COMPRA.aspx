<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_COMPRA.aspx.cs" Inherits="SoprodiApp.REPORTE_COMPRA" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    <script>
        ...
        function CargarEvento_Tabla(id, rut, fact, tipo_doc) {
            ...
            $.ajax({
                type: "POST",
                url: "REPORTE_COMPRA.aspx/CargarEvento55",
                data: parameters,
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Compras</h3>
                                <div class="box-tool">
                                                    ...
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <div runat="server" id="div_sw_permiso">
                                                                ...
                                                                <div runat="server" id="div5" style="visibility: hidden; position: absolute">
                                                            ...
                                                            <div style="visibility: hidden; position: absolute">
                                                                <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Proveedor</label>
                                                                <div class="col-sm-4 col-lg-4">
                                                                    <div class="controls">
                                                                        <asp:ListBox ID="d_proveedor" SelectionMode="Multiple" data-placeholder=" -- Todos -- " runat="server" class="form-control chosen-select"></asp:ListBox>
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <div runat="server" id="comexx" visible="false">
                                                                <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">OC</label>
                                                                <div class="col-sm-2 col-lg-2 controls">
                                                                    <div class="input-group">

                                                                        <asp:TextBox ID="tx_oc" CssClass="form-control" runat="server" Width="50%"></asp:TextBox>

                                                                    </div>
                                                                </div>
                                                                <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">DI</label>
                                                                <div class="col-sm-2 col-lg-2 controls">
                                                                    <div class="input-group">

                                                                        <asp:TextBox ID="tx_di" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="table-responsive" style="border: 0">
                                                    ...
                                                    <div class="box">
                                                        <div class="form-group" style="overflow: auto">
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_VENDEDOR" ClientIDMode="Static" CssClass="table table-bordered filtrar" OnRowDataBound="G_INFORME_TOTAL_VENDEDOR_RowDataBound" runat="server"
                                                                ShowHeaderWhenEmpty="True" DataKeyNames="cod, nbr" Font-Size="12px">
                                                            ...
                                                            <asp:GridView ID="G_EXCEL" ClientIDMode="Static" CssClass="table table-bordered filtrar" OnRowDataBound="G_EXCEL_RowDataBound" runat="server"
                                                                ShowHeaderWhenEmpty="True" DataKeyNames="cod, nbr" Font-Size="12px">
                                                                <HeaderStyle CssClass="test no-sort" />
                                                                <Columns>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group" runat="server" id="gama" visible="false" style="overflow: auto">
