<%@ Page Title="" Language="C#" MasterPageFile="~/COTIZADOR/Cotizador2.Master" AutoEventWireup="true" CodeBehind="Dashboard_vend_cliente.aspx.cs" Inherits="SoprodiApp.COTIZADOR.Dashboard_vend_cliente" %>
                                        ...
                                        <ContentTemplate>
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <asp:DropDownList runat="server" CssClass="form-control" ID="CB_VENDEDORES"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <ul class="list-inline clearfix mt-2 mb-0">
                                                <li class="border-right-grey border-right-lighten-2 pr-2">
                                                    ...
                                                    <span class="success">Productos Cotizados</span>
                                                </li>
                                                <li class="pl-2">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div style="display: none">
                                                <asp:LinkButton runat="server" ID="b_llenar_clte_cotizados" OnClick="b_llenar_clte_cotizados_Click1" ClientIDMode="Static"></asp:LinkButton>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        <div class="card-header mb-2">
                                            <span class="success darken-1"><b>Clientes Cotizados</b></span>
                                        </div>
                                        <div class="card-content">
                                            <asp:GridView DataKeyNames="" runat="server" ID="G_DET_CLIENTESCOTIZADOS" CssClass="table table-bordered compact table-xs" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                                                <Columns>
                                                    <asp:BoundField HeaderText="Veces" DataField="contador" />
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body text-center">
                                                <div class="card-header mb-2">
                                                    <span class="success darken-1"><b>Cotizaciones Enviadas</b></span>
                                                </div>
                                                <div class="card-content">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <asp:UpdatePanel runat="server" ID="up_modal_clte_cotizados" UpdateMode="Conditional">
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="G_COTIZADOS_NOCOTIZADOS" />
                    </Triggers>
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <hr />
                                    <div class="table-responsive">
                                        <asp:GridView DataKeyNames="" runat="server" ID="G_COTIZADOS_NOCOTIZADOS" CssClass="table table-bordered compact table-xs" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
...
<asp:Content ID="Content2" ContentPlaceHolderID="CODIGO_JAVASCRIPT" runat="server">
    <script>
        ...
        function Datatables() {
            ...
            try {
                $('#<%= G_COTIZADOS_NOCOTIZADOS.ClientID %>').DataTable({
                     "language": {
                         "decimal": ",",
                         "thousands": "."
                     },                   
