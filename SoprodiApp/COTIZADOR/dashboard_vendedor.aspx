<%@ Page Title="" Language="C#" MasterPageFile="~/COTIZADOR/Cotizador.Master" AutoEventWireup="true" CodeBehind="dashboard_vendedor.aspx.cs" Inherits="SoprodiApp.COTIZADOR.dashboard_vendedor" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <asp:UpdatePanel runat="server" ID="PRINCIPAL" U>
                                        <Triggers>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <%--<h4 class="modal-title" id="myModalLabel18"><b>Clientes Cotizados</b></h4>--%>
