<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_PERMANENCIA.aspx.cs" Inherits="SoprodiApp.REPORTE_PERMANENCIA" %>
    ...
    <script>
        ...
        function LoadProduc(result) {
            ...
            $.each(result.d, function () {
                ...
                $("#<%=d_productos.ClientID%>").append($("<option></option>").attr("value", this.COD_PROD).text(this.NOM_PROD))
...
--%>
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Permanencia</li>
                </ul>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12" id="div_superior">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Permanencia</h3>
                                <div class="box-tool">
                                            ...
                                            <div class="form-group" style="display: block">
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="d_chofer" ClientIDMode="Static" CssClass="form-control chosen"></asp:DropDownList>
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="d_camion" ClientIDMode="Static" CssClass="form-control chosen"></asp:DropDownList>
