<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES"  CodeBehind="REPORTE_LV_B.aspx.cs" Inherits="SoprodiApp.REPORTE_LV_B" %>
            ...
            <script type="text/javascript">
                ...
                function BindEvents() {
                    ...
                    $("#<%=d_grupos_usuario.ClientID%>").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_LV_B.aspx/BODEGA_VENDEDOR",
                            data: parameters,
...
<%--            <div class="page-title" style="margin-top: -27px">
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Reporte análisis por bodega</li>
                </ul>
            </div>
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box" runat="server" id="filtros">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Análisis por Bodega</h3>
                                <div class="box-tool">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box">
                                                <div class="pull-right">
                                                    <div class="btn-group">
                                                        <asp:Button ID="btn_productos" runat="server" OnClientClick="CARGANDO();" Style="color: white; float: right;" Class="btn btn-success" OnClick="btn_productos_Click" Text="Análisis por Bodega" />
                        ...
                        <div id="div2" runat="server" class="row" style="visibility: visible">
                            <div id="div4" runat="server" class="row" visible="false">
                                <div class="col-md-12">
                                    <div class="box">
                                        <div class="box-title">
                                            <h3><i class="fa fa-table"></i>Detalle por bodega</h3>
                                            <div class="box-tool">
                                                <a data-action="collapse" href="#"></a>
                        ...
                        <div id="div1" runat="server" class="row" style="visibility: visible">
                            <div id="div3" runat="server" class="row" visible="false">
                                <div class="col-md-12">
                                    <div class="box">
                                        <div class="box-title">
                                            <h3><i class="fa fa-table"></i>Detalle periodo de bodegas</h3>
                                            <div class="box-tool">
                                                <a data-action="collapse" href="#"></a>
                                        ...
                                        <div class="box-content">
                                            <div id="filtro_memoria_div2" runat="server"></div>
                                            <div class="btn-toolbar pull-right">
                                            ...
                                            <div class="table-responsive" style="border: 0">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div>
                                                            <div class="DivRoot" id="Div5" runat="server">

                                                                <div runat="server" style="overflow-y: auto" id="Div6">
                                                                </div>
                                                                   <div runat="server" id="R_Excel_2" style="display: none">
                                                                </div>
                                                            </div>
