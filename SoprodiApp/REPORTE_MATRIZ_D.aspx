<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_MATRIZ_D.aspx.cs" Inherits="SoprodiApp.REPORTE_MATRIZ_D" %>
    ...
    <script>
        ...
        function CARGA_FECHA() {
          ...
          function SIDEBAR_ABARROTE() {
              ...
              document.getElementById("REPORTE_MATRIZ_D").className = "";
            ...
            <script type="text/javascript">
                ...
                function BindEvents() {
                    ...
                    $("#<%=d_grupos_usuario.ClientID%>").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ_D.aspx/BODEGA_POR_GRUPO",
                            data: parameters,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ_D.aspx/VENDEDOR_POR_GRUPO",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ_D.aspx/CLIENTE_POR_VENDEDOR",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
...
<%--
                    ...
                    $("#<%=d_bodegas2.ClientID%>").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ_D.aspx/VENDEDOR_POR_BODEGA",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ_D.aspx/CLIENTE_POR_BODEGA",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Reporte Matriz de Ventas</li>
                </ul>
            </div>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Reporte Matriz de Ventas por dias</h3>
                                <div class="box-tool">
