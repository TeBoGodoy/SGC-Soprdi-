<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="MANT_ANALISIS.aspx.cs" Inherits="SoprodiApp.MANT_ANALISIS" %>
   ...
   <%-- <div class="page-title" style="margin-top: -27px">
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb" style="height: 40px !important;">
            ...
            <li class="active">Mantenedor Analisis</li>
        </ul>
    </div>
    ...
    <div id="main-content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i>Mantenedor Analisis</h3>
                    </div>
                    <div class="box-content">
                        ...
                        <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UP_SubirArchivo">
                            <ContentTemplate>                                
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 controls">
                                                <asp:TextBox runat="server" ID="T_Cod_Analisis" CssClass="form-control input-sm" Enabled="false"></asp:TextBox>
                                            </div>
                                            <label class="col-sm-2 control-label">
                                                <b>Nombre</b>
                                            </label>
                                            <div class="col-sm-3 controls">
                                                <asp:TextBox runat="server" ID="T_Nom_Analisis" CssClass="form-control input-sm" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-1 col-sm-offset-1 controls">
                                                <button id="btn_nuevo_Analisis" class="btn btn-success icon-plus btn-circle" runat="server" onserverclick="btn_nuevo_Analisis_ServerClick"><i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <asp:GridView CssClass="table fill-head table-bordered filtrar" ID="G_Lab" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True" Width="100%" OnRowCommand="G_Lab_RowCommand" DataKeyNames="id, cod_analisis, nom_analisis">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Codigo" DataField="cod_analisis" />
                                                <asp:BoundField HeaderText="Nombre" DataField="nom_analisis" />
                                            </Columns>
                                            <EmptyDataTemplate>
                                                No existen datos.
                                            </EmptyDataTemplate>
