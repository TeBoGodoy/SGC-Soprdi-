...
{
    public partial class REPORTE_LISTADO_DOC : System.Web.UI.Page
    {
        ...
        protected void G_INFORME_TOTAL_VENDEDOR_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[2].Text = Base.ficha_cliente(cliente, e.Row.Cells[2].Text);

                e.Row.Cells[1].Text = Base.format_rut(e.Row.Cells[1].Text);
                e.Row.Cells[6].Text = Base.monto_format(e.Row.Cells[6].Text);

                e.Row.Cells[5].Text = e.Row.Cells[5].Text.Substring(0, 10);


                e.Row.Cells[0].Text = Base.click_factura(e.Row.Cells[5].Text, e.Row.Cells[0].Text);
