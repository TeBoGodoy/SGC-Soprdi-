<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_LISTADO_DOC.aspx.cs" Inherits="SoprodiApp.REPORTE_LISTADO_DOC" %>
        ...
        <ContentTemplate>
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Busca Nº Documento</li>
                </ul>
            </div>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Busca Nº Documento</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="form-group">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                                        ...
                                                        <ContentTemplate>
                                                            ...
                                                            <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Nº Documento</label>
                                                            <div class="col-sm-9 col-lg-9">
                                                                <div class="controls">
                                                                    <asp:TextBox ID="Txt_num_doc" data-placeholder="1111, 22222, 33333 " runat="server" class="form-control"></asp:TextBox>
                                                                </div>
                    ...
                    <div id="div1" runat="server" class="row" style="visibility: visible">
                        <div id="div_report" runat="server" class="row" visible="false">
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        <h3><i class="fa fa-table"></i>Detalle Documento</h3>
                                        <div class="box-tool">
                                            <a data-action="collapse" href="#"></a>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_VENDEDOR" CssClass="table table-bordered filtrar" OnRowDataBound="G_INFORME_TOTAL_VENDEDOR_RowDataBound" runat="server" Visible="false"
