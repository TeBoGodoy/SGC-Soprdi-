<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_MATRIZ.aspx.cs" Inherits="SoprodiApp.REPORTE_MATRIZ" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    ...
    <script>
        ...
        function LoadBodegas(result) {

            //quito los options que pudiera tener previamente el combo

            $("#<%=d_bodegas2.ClientID%>").html("");


            //recorro cada item que devuelve el servicio web y lo a̱ado como un opcion
            $.each(result.d, function () {

                $("#<%=d_bodegas2.ClientID%>").append($("<option></option>").attr("value", this.cod_vendedor).text(this.cod_vendedor))
            ...
            $("#<%=d_cliente.ClientID%>").chosen();
            $("#<%=d_cliente.ClientID%>").trigger("chosen:updated");
            $("#<%=d_bodegas2.ClientID%>").chosen();
            $("#<%=d_bodegas2.ClientID%>").trigger("chosen:updated");
        ...
        function CARGA_FECHA() {
          ...
          function SIDEBAR_ABARROTE() {
              ...
              document.getElementById("REPORTE_MATRIZ").className = "";
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="360000" EnableScriptGlobalization="True" EnableScriptLocalization="True">
            ...
            <script type="text/javascript">
                ...
                function BindEvents() {
                    ...
                    $("#<%=d_grupos_usuario.ClientID%>").change(function () {
                        ...
                        document.getElementById("<%=l_bodegas.ClientID %>").value = "";
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ.aspx/BODEGA_POR_GRUPO",
                            data: parameters,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ.aspx/VENDEDOR_POR_GRUPO",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ.aspx/CLIENTE_POR_VENDEDOR",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
...
<%--
                    ...
                    $("#<%=d_bodegas2.ClientID%>").change(function () {

                        // armo el objeto que servira de parametro, para ello utilizo una libreria de JSON
                        //este parametro mapeara con el definido en el web service

                        var arr = $(this).val();
                        document.getElementById("<%=l_bodegas.ClientID %>").value = arr;

                        var parameters = new Object();

                        parameters.bodegas = document.getElementById("<%=l_bodegas.ClientID %>").value;
                        parameters.grupos = document.getElementById("<%=l_grupos.ClientID %>").value;
                        parameters.desde = document.getElementById("<%=txt_desde.ClientID %>").value;
                        parameters.hasta = document.getElementById("<%=txt_hasta.ClientID %>").value;
                        parameters.usuario = document.getElementById("<%=l_usuario_.ClientID %>").value;
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ.aspx/VENDEDOR_POR_BODEGA",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                            success: LoadVendedores,
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                alert("Error al cargar LoadVendedores");
                            }
                        });

                        $.ajax({
                            type: "POST",
                            url: "REPORTE_MATRIZ.aspx/CLIENTE_POR_BODEGA",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                            success: LoadClientes,
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                alert("Error al cargar LoadClientes");
                            }
                        });
                  ...
                  <%--      
                    ...
                    $("#<%=d_cliente.ClientID %>").change(function () {
                       ...
                       $("#<%=d_producto.ClientID %>").change(function () {
                        var arr = $(this).val();
                        document.getElementById("<%=l_productos2.ClientID %>").value = arr;
                    })
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Reporte Matriz de Ventas por producto</li>
                </ul>
            </div>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Reporte Matriz de Ventas por producto</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <div id="Div4" class="col-sm-1 col-lg-1" runat="server" visible="false">
                                                                <div class="controls">
                                                            ...
                                                            <div class="col-sm-3 col-lg-3">
                                                                <div class="controls">
                                                                    <asp:ListBox ID="d_bodegas2" SelectionMode="Multiple" data-placeholder=" -- Todos -- " runat="server" class="form-control chosen-select"></asp:ListBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3 col-lg-3 controls">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <div runat="server" id="div6" style="display: block;">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <div runat="server" id="div5" style="display: block;">
                                                            ...
                                                            <div id="Div7" class="col-sm-1 col-lg-1" runat="server" visible="false">
                                                                <div class="controls">
                                                                    <%--                                                            <asp:ImageButton ID="b" ImageUrl="~/img/Ticket_verde.png" Width="30%" runat="server" OnClick="btn_filtro_vend_Click" />--%>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2 controls">
                                                        <div class="input-group" id="check_cerrados">
                                                            <asp:RadioButton ID="rd_cerr" Text="&nbsp;&nbsp;En Ventas" Style="padding-right: 20px;"
                                                                GroupName="cerrados" runat="server" />

                                                            <asp:RadioButton ID="rd_abi" Style="padding-right: 20px;" Text="&nbsp;&nbsp;En Stock" Checked="True"
                                                                GroupName="cerrados" runat="server" />
                                                        </div>
                                                    </div>
                    ...
                    <div id="div2" runat="server" class="row" style="visibility: visible">
                        <div id="div_productos" runat="server" class="row" visible="false">
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        <h3><i class="fa fa-table"></i>Matriz</h3>
                                        <div class="box-tool">
                                            <a data-action="collapse" href="#"></a>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        ...
                                                        <div class="form-group" id="DivMainContent" style="overflow-x: auto;">
                                                            ...
                                                            <div id="table_matriz" runat="server"></div>
    ...
    <asp:TextBox ID="l_productos" runat="server" Style="visibility: hidden; position: absolute;"></asp:TextBox>
        <asp:TextBox ID="l_productos2" runat="server" Style="visibility: hidden; position: absolute;"></asp:TextBox>
    <asp:TextBox ID="l_periodos" runat="server" Style="visibility: hidden; position: absolute;"></asp:TextBox>
    <asp:TextBox ID="l_bodegas" runat="server" Style="visibility: hidden; position: absolute;"></asp:TextBox>
