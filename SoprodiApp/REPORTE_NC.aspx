<%--@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_NC.aspx.cs" Inherits="SoprodiApp.REPORTE_NC" --%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" AutoEventWireup="True" CodeBehind="REPORTE_NC.aspx.cs" UICulture="es-ES" Culture="es-ES" Inherits="SoprodiApp.REPORTE_NC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    <script>
        ...
        function cierra() {
            ...
            var table = document.getElementById('ContentPlaceHolder_Contenido_G_INFORME_TOTAL_NC');
        ...
        <ContentTemplate>
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Reporte Notas de Crédito </li>
                </ul>
            </div>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Reporte Notas de Crédito</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                ...
                                <div class="table-responsive" style="border: 0">
                                            ...
                                            <div class="box">
                                                <div class="form-group" style="display: none">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                                        ...
                                                        <ContentTemplate>
                                                            <div runat="server" id="div_sw_permiso" style="visibility: visible;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="box">
                                                <label class="col-sm-1 col-lg-1 control-label" style="top: 5px; display: none">Percentil</label>
                                                <div class="col-sm-1 col-lg-1">
                                                    <div class="input-group" style="width: 80px" style="display: none">
                                                        <asp:TextBox ID="t_percentil" runat="server" Text="50" class="form-control" Style="width: 100%; display: none" onkeypress="CheckNumeric(event);" MaxLength="2"></asp:TextBox>
                    ...
                    <div id="div1" runat="server" class="row" style="visibility: visible">
                        <div id="div_report" runat="server" class="row" visible="false">
                            <div class="col-md-12">
                                <div class="box">
                                    <div class="box-title">
                                        <h3>Detalle Notas de Crédito</h3>
                                        <div class="box-tool">
                                            <a data-action="collapse" href="#"></a>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group" style="overflow-x: auto;">
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_NC" CssClass="table table-bordered filtrar" OnRowDataBound="g_doc_RowDataBound" runat="server" Visible="false"
                                                            ...
                                                            <asp:GridView ID="G_INFORME_NC" CssClass="table table-bordered filtrar" OnRowDataBound="G_INFORME_NC_RowDataBound" runat="server" Visible="false"
                                                                ShowHeaderWhenEmpty="True" Font-Size="12px">
                                                                <HeaderStyle CssClass="test no-sort" />
                                                                <Columns>
                                                                </Columns>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        ...
                                                        <div class="form-group" id="DivMainContent" style="overflow-x: auto;">
                                                            ...
                                                            <%--<asp:GridView ID="G_INFORME_TOTAL_NC" AutoGenerateColumns="true" CssClass="table table-bordered filtrar" OnRowCommand="G_INFORME_TOTAL_NC_RowCommand" OnRowDataBound="G_INFORME_TOTAL_NC_RowDataBound" runat="server" Visible="true"
