<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_SP.aspx.cs" Inherits="SoprodiApp.REPORTE_SP" %>
    ...
    <script>
        ...
        function creagrilla() {
            try {
                ...
                var fecha5 = $('th:contains("FechaPlanificado")').index();
                $("#G_INFORME_TOTAL_VENDEDOR").DataTable({
                    ...
                    "paging": false,
                    columnDefs: [
                     { type: 'date-uk', targets: [fecha1, fecha2, fecha3, fecha4, fecha5] }
                    ],
                    "language": {
                        "decimal": ",",
                        "thousands": "."
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12" id="div_superior">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>SP</h3>
                                <div class="box-tool">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4 col-lg-4">
                                                                <div class="controls">
                                                                     ...
                                                                     <%--<asp:DropDownList runat="server" ID="d_estado_2" ClientIDMode="Static" CssClass="form-control chosen"></asp:DropDownList>--%>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <asp:Button ID="btn_eliminar_check" runat="server" OnClientClick="CARGANDO();" Style="color: white;" Class="btn btn-warning" OnClick="btn_eliminar_check_Click" Text="Eliminar Grupo" />
                                                        ...
                                                        <div class="form-group" style="overflow: auto">
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_VENDEDOR" ClientIDMode="Static" CssClass="table table-bordered table-advance filtrar" OnRowCommand="G_INFORME_TOTAL_VENDEDOR_RowCommand" OnRowDataBound="G_INFORME_TOTAL_VENDEDOR_RowDataBound" runat="server"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Rechazar SP">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Enviar SP">
                                                                        <ItemTemplate>
                                                                            <asp:ImageButton ID="B_enviar" runat="server" ImageUrl="img/email.png" Width="25"
                                                                                CommandName="Enviar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" OnClientClick='<%# abrir_modal( Eval("CODDOCUMENTO").ToString()  ) %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
