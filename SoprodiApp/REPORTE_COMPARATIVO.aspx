<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" AutoEventWireup="true" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_COMPARATIVO.aspx.cs" Inherits="SoprodiApp.REPORTE_COMPARATIVO" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    ...
    <script>
        ...
        function CARGANDO() {
            ...
            var elem5 = document.getElementById("<%=div3.ClientID%>");
       elem5.style.visibility = "hidden";
       var elem6 = document.getElementById("<%=div4.ClientID%>");
            ...
            <script type="text/javascript">
                ...
                function BindEvents() {
                    ...
                    $("#<%=d_grupos_usuario.ClientID%>").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_COMPARATIVO.aspx/VENDEDOR_POR_GRUPO",
                            data: parameters,
                        ...
                        $.ajax({
                            type: "POST",
                            url: "REPORTE_COMPARATIVO.aspx/CLIENTE_POR_VENDEDOR",
                            data: parameters,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
...
<%--              <div class="page-title" style="margin-top: -27px">
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Reporte comparativo</li>
                </ul>
            </div>
            <div id="main-content">
                <!-- BEGIN Main Content -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Reporte Comparativo</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="form-group">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                                        ...
                                                        <ContentTemplate>
                                                            ...
                                                            <div id="Div1" class="col-sm-3 col-lg-3" runat="server">
                                                                <div class="controls">
                ...
                <div id="div3" runat="server" class="row" style="visibility: visible">
                    <div id="div_report" runat="server" class="row" visible="false">
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-title">
                                    <h3><i class="fa fa-table"></i>Detalle Comparativo</h3>
                                    <div class="box-tool">
                                        <a data-action="collapse" href="#"></a>
                ...
                <div id="div4" runat="server" class="row" style="visibility: visible">
                                            ...
                                            <div class="col-md-12">
                                                <div class="box">
                                                    <div class="form-group" style="overflow-x: auto;">
                                                        ...
                                                        <asp:GridView ID="G_PRODUCTOS" CssClass="table table-bordered filtrar" runat="server" Visible="true"
                                                            ShowHeaderWhenEmpty="True" Font-Size="12px">
                                                            <HeaderStyle CssClass="test" />
                                                            <Columns>
                                                            </Columns>
