<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_LV_C.aspx.cs" Inherits="SoprodiApp.REPORTE_LV_C" %>
          ...
          <%--  <div class="page-title" style="margin-top: -27px">
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Análisis Comparativo de grupos (Diario y Periodos)</li>
                </ul>
            </div>
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box" runat="server" id="filtros">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Análisis Comparativo de grupos (Diario y Periodos)</h3>
                                <div class="box-tool">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box">
                                                <div class="pull-right">
                                                    <div class="btn-group">
                                                        <asp:Button ID="btn_productos" runat="server" OnClientClick="CARGANDO();" Style="color: white; float: right;" Class="btn btn-success" OnClick="btn_productos_Click" Text="Análisis grupo" />
                        ...
                        <div id="div2" runat="server" class="row" style="visibility: visible">
                            <div id="div4" runat="server" class="row" visible="false">
                                <div class="col-md-12">
                                    <div class="box">
                                        <div class="box-title">
                                            <h3><i class="fa fa-table"></i>Detalle periodo de grupos</h3>
                                            <div class="box-tool">
                                                <a data-action="collapse" href="#"></a>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div>
                                                            <div class="DivRoot" id="tabla" runat="server">
                                                                ...
                                                                <div runat="server" style="overflow-y: auto" id="DivMainContent">
                                                                </div>
