<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_VENCIMIENTOS.aspx.cs" Inherits="SoprodiApp.REPORTE_VENCIMIENTOS" %>
...
<%--
        ...
        function INGRESO_CERTIFICADO(invtid, siteid, batnbr, refnbr, trandate, trantype) {

            var estado = document.getElementById("cb_cambio_pago" + invtid + "*#" + siteid + "*#" + batnbr + "*#" + refnbr + "*#" + trandate + "*#" + trantype).value;
            var parameters = new Object();


            parameters.invtid_ = invtid;
            parameters.siteid_ = siteid;
            parameters.batnbr_ = batnbr;
            parameters.refnbr_ = refnbr;
            parameters.trandate_ = trandate;
            parameters.trantype_ = trantype;
            ...
            $.ajax({
                type: "POST",
                url: "REPORTE_VENCIMIENTOS.aspx/CERTIFICADO",
                data: parameters,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Vencimiento</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group" style="overflow: auto">
                                                            ...
                                                            <asp:GridView ID="G_GRID2" ClientIDMode="Static" CssClass="table table-bordered filtrar" runat="server" Visible="true"
                                                                ShowHeaderWhenEmpty="True" Font-Size="13px" AutoGenerateColumns="true">
                                                            ...
                                                            <asp:GridView ID="G_GRID" ClientIDMode="Static" CssClass="table table-bordered filtrar" OnRowDataBound="G_GRID_RowDataBound" OnRowCommand="G_GRID_RowCommand" runat="server" Visible="true"
                                                                ShowHeaderWhenEmpty="True" Font-Size="13px" AutoGenerateColumns="false" DataKeyNames="invtid, siteid, batnbr, refnbr, trandate, trantype, id, fecha_">
                                                                <HeaderStyle CssClass="test no-sort" />
                                                                <Columns>

                                                                    <asp:BoundField DataField="PRODUCTO" HeaderText="Producto" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="trantype" HeaderText="T.Mov" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="FECHA_" HeaderText="Fecha" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="siteid" HeaderText="bodega" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="batnbr" HeaderText="batnbr" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="refnbr" HeaderText="refnbr" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="qty" HeaderText="cantidad" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="queda" HeaderText="Queda" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="ton" HeaderText="TON" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>

                                                                    <%--                                                                    <asp:TemplateField HeaderText="Lote">
                                                                        <ItemTemplate>
                                                                            <div id="prueba_div1" style="height: 0px; width: 0px; overflow: hidden">
                                                                            </div>
                                                                            <asp:TextBox runat="server" ID="txt_lote" Style="width: 100px;" Text='<%# Eval("lote") %>' CssClass="txtgrilla" />

                                                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="/img/save.png" Width="17"
                                                                                CommandName="click_guarda_lote" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Width="15px" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:TemplateField>--%>

                                                                    <%--        <asp:TemplateField HeaderText="Envasado">
                                                                        <ItemTemplate>
                                                                            <div id="prueba_div2" style="height: 0px; width: 0px; overflow: hidden">
                                                                            </div>
                                                                            <asp:TextBox runat="server" ID="txt_envasado" Style="width: 100px;" Text='<%# Eval("envasado") %>' CssClass="txtgrilla" />

                                                                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="/img/save.png" Width="17"
                                                                                CommandName="click_guarda_envasado" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Width="15px" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Vencimiento">
                                                                        <ItemTemplate>
                                                                            <div id="prueba_div3" style="height: 0px; width: 0px; overflow: hidden">
                                                                            </div>
                                                                            <asp:TextBox runat="server" ID="txt_Vencimiento" Style="width: 100px;" Text='<%# Eval("vencimiento") %>' CssClass="txtgrilla" />

                                                                            <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="/img/save.png" Width="17"
                                                                                CommandName="click_guarda_vencimiento" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Width="15px" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:TemplateField>--%>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Lotes">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="/img/images.jpg" Width="17"
                                                                                CommandName="click_modal_lotes" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Width="15px" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:BoundField DataField="envasado" HeaderText="F.Envasado" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="vencimiento" HeaderText="F.Vencimiento" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>



                                                                    <asp:BoundField DataField="dif_envasado_vencimiento" HeaderText="Duración Meses" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="dif_envasado_hoy" HeaderText="Desde Envasado" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="vida_util" HeaderText="Vida Util" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>


                                                                    <asp:BoundField DataField="porc_vida_util" HeaderText="% Vida Util utilizado" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <%--                          <asp:TemplateField HeaderText="Certificado">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:ListBox runat="server" ID="certif" data-placeholder=" -- -- " SelectionMode="Single" CssClass="form-control chosen">
                                                                          ...
                                                                          <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="/img/save.png" Width="17"
                                                                                CommandName="click_guarda_certificado" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Width="15px" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:TemplateField>--%>
                                                                    ...
                                                                    <asp:BoundField DataField="certificado" HeaderText="Certificado" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>

                                                                    <asp:BoundField DataField="Porcentaje_Despachado" HeaderText="Porcentaje_Despachado" HeaderStyle-HorizontalAlign="Center" Visible="true">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li><span class="label label-important" style="background-color: #F1C40F;">&nbsp;&nbsp;&nbsp;&nbsp;</span> 50% vida util</li>
                                                    <li><span class="label label-important" style="background-color: #D35400;">&nbsp;&nbsp;&nbsp;&nbsp;</span> 6 meses vida util</li>
                                                    <li><span class="label label-important" style="background-color: #FF0000;">&nbsp;&nbsp;&nbsp;&nbsp;</span> 3 meses o menos del 30% de vida util</li>
                                                    <li><span class="label label-important" style="background-color: #7D3C98;">&nbsp;&nbsp;&nbsp;&nbsp;</span> 20% despachado sin resolución sanitaria</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3 col-lg-3 controls">
                                            <div class="input-group">
                                                ...
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="t_envasado" Format="dd/MM/yyyy" />
                                        ...
                                        <div class="col-sm-3 col-lg-3 controls">
                                            <div class="input-group">
                                                ...
                                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="t_vencimiento" Format="dd/MM/yyyy" />
