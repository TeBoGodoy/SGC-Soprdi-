<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_MOV_STOCK.aspx.cs" Inherits="SoprodiApp.REPORTE_MOV_STOCK" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    <script>
        ...
        function creagrilla() {
            try {
                var fecha1 = $('th:contains("trandate")').index();
...
--%>
                    ...
                    $("#<%=d_tipo_mov.ClientID%>").change(function () {

                        var arr = $(this).val();
                        document.getElementById("<%=l_tipo_mov.ClientID %>").value = arr;
                    ...
                    $("#<%=d_producto.ClientID%>").change(function () {
                        ...
                        var arr = $(this).val();
                        document.getElementById("<%=l_productos.ClientID %>").value = arr;
                    ...
                    $("#<%=d_tipo_mov.ClientID%>").chosen();
                    $("#<%=d_tipo_mov.ClientID%>").trigger("chosen:updated");
...
--%>
            ...
            <div id="breadcrumbs">
                <ul class="breadcrumb" style="height: 40px !important;">
                    ...
                    <li class="active">Movimientos Stock</li>
                </ul>
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12" id="div_superior">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Movimientos Stock</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Bodegas</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Tipo Movimiento</label>
                                                            <div class="col-sm-4 col-lg-4">
                                                                <div class="controls">
                                                                    <asp:ListBox ID="d_tipo_mov" SelectionMode="Multiple" data-placeholder=" -- Todos -- " runat="server" class="form-control chosen-select"></asp:ListBox>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <asp:Button ID="btn_eliminar_check" runat="server" OnClientClick="CARGANDO();" Style="color: white; visibility: hidden; position: absolute;" Class="btn btn-warning" OnClick="btn_eliminar_check_Click" Text="Eliminar Grupo" />
    ...
    <asp:TextBox ID="l_tipo_mov" runat="server" Style="visibility: hidden; position: absolute;"></asp:TextBox>
