...
{
    public partial class REPORTE_LV_C : System.Web.UI.Page
    {
        ...
        protected void btn_productos_Click(object sender, EventArgs e)
        {
            ...
            if (l_grupos.Text != "") { where += " and user1 in (" + agregra_comillas(l_grupos.Text) + ")"; }
            ...
            if (l_grupos.Text != "") { where2 += " and user1 in (" + agregra_comillas(l_grupos.Text) + ")"; }
            ...
            if (l_grupos.Text != "") { where3 += " and user1 in (" + agregra_comillas(l_grupos.Text) + ")"; }
        ...
        public string crear_reporte_correo2(DataTable dataTable, DataTable totales, string DESDE, string HASTA, string grupos)
        {
            ...
            foreach (DataRow r in dataTable.Rows)
            {
                ...
                while (DESDE != HASTA)
                {
                    ...
                    string script = "";
                    if (venta_ != 0) { v = venta_.ToString("N0"); script = string.Format("javascript:fuera(&#39;{0}&#39;, &#39;{1}&#39;, &#39;{2}&#39;, &#39;{3}&#39;)", encriptador.EncryptData(HASTA), encriptador.EncryptData(cod_vendedor), encriptador.EncryptData(grupos.Trim().Replace("'", "")), encriptador.EncryptData("2")); }
