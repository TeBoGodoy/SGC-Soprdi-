<%@ Page Title="" ViewStateMode="Enabled" Language="C#" MasterPageFile="~/Base.Master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" UICulture="es-ES" Culture="es-ES" CodeBehind="REPORTE_INSTRUIR.aspx.cs" Inherits="SoprodiApp.REPORTE_INSTRUIR" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_Contenido" runat="server">
    <script>
        ...
        function instruir_jv(dia) {

            dia_instr = dia.substring(0, 10);
            //alert('Día Instruido!'+dia);

            //document.getElementById("ContentPlaceHolder_Contenido_txt_instruir").value = dia;

            //document.getElementById("ContentPlaceHolder_Contenido_btn_instrbtn_instr").click();


            var parameters = new Object();
            parameters.dia = dia_instr;
            parameters = JSON.stringify(parameters);

            $.ajax({
                type: "POST",
                url: "REPORTE_INSTRUIR.aspx/INSTRUIR",
                data: parameters,
                ...
                $('#tabla_html').html(resp.split("*")[0]);
                //$('#ContentPlaceHolder_Contenido_btn_instr_correos_inst').html(resp.split[1]);

                document.getElementById("ContentPlaceHolder_Contenido_correos_inst").value = resp.split("*")[1];

                //alert(resp.split("*")[2]);
                document.getElementById("ContentPlaceHolder_Contenido_titulo_modal_22").value = resp.split("*")[2];
                $('#modal_5').click();
            });
        }
...
<%--            var elem5 = document.getElementById("<%=div1.ClientID%>");
            ...
            var elem3 = document.getElementById("<%=enviando_correo.ClientID%>");
            elem3.style.display = "block";
        ...
        function chosen_update() {
            ...
            $("#<%=d_camion_.ClientID%>").chosen();
            $("#<%=d_camion_.ClientID%>").trigger("chosen:updated");
                ...
                <div class="modal-dialog modal-lg" style="width: 90%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <%--<h3 runat="server" style="visibility:hidden;position:absolute;" id=""></h3>--%>


                            <asp:TextBox runat="server" CssClass="form-control" Style="visibility: hidden; position: absolute;" ID="titulo_modal_22"></asp:TextBox>
                        </div>
                        ...
                        <asp:UpdatePanel runat="server" ID="UpdatePanel5" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div class="modal-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box">
                                                <div class="form-group" style="overflow: auto;">
                                                    ...
                                                    <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;"><b>Obs</b></label>

                                                    <div class="col-sm-4 controls">
                                                        <%--<asp:TextBox runat="server" ID="t_ob_cobro" ClientIDMode="Static" CssClass="form-control input-sm"></asp:TextBox>--%>
                                                        <textarea runat="server" id="Textarea1" class="form-control" placeholder="Observación" rows="2"></textarea>

                                                    </div>
                                                    <%--    <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;"><b>Correos</b></label>--%>

                                                    <div class="col-sm-4 controls">

                                                        <asp:TextBox runat="server" Style="visibility: hidden; position: absolute;" CssClass="form-control" ID="correos_inst"></asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-2 controls">
                                                        <asp:Label runat="server" Style="color: red;" ID="notifi"></asp:Label>



                                                        <asp:Button ID="Button2" runat="server" Style="color: white;" OnClientClick="CARGANDO3();" Class="btn btn-lime" OnClick="Button2_Click1" Text="Notificar Bodegas" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <i class="fa fa-cog fa-spin fa-3x fa-fw margin-bottom" id="enviando_correo" runat="server" style="display: none; font-size: 3em;"></i>
...
--%>
                    ...
                    $("#<%=d_camion_.ClientID%>").change(function () {
                        var arr = $(this).val();
            ...
            <div id="main-content">
                ...
                <div class="row">
                    <div class="col-md-12" id="div_superior">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i>Instruir</h3>
                                <div class="box-tool">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Camión</label>
                                                            <div class="col-sm-4 col-lg-4">
                                                                <div class="controls">
                                                                    <asp:ListBox ID="d_camion_" SelectionMode="Multiple" data-placeholder=" -- Todos -- " runat="server" class="form-control chosen-select"></asp:ListBox>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <label class="col-sm-1 col-lg-1 control-label" style="top: 5px;">Mostrar No Planificado</label>
                                                            <div class="col-sm-4 col-lg-4">
                                                                <div class="controls">
                                                                    <asp:CheckBox runat="server" ID="chk_no_plan" CssClass="form-control" Checked="false" />
                                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <button runat="server" id="btn_instr" style="visibility: hidden; position: absolute;" onserverclick="instruir_ServerClick"></button>
                                        <asp:TextBox runat="server" ID="txt_instruir" Style="visibility: hidden; position: absolute;"></asp:TextBox>
                                        <div class="clearfix"></div>
                                        <div class="table-responsive" style="border: 0">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="box">
                                                        <div class="form-group" style="overflow: auto">
                                                            ...
                                                            <div runat="server" id="tabla_instruir"></div>
                                                            ...
                                                            <asp:GridView ID="G_INFORME_TOTAL_VENDEDOR" ClientIDMode="Static" CssClass="table table-bordered table-advance filtrar" OnRowCommand="G_INFORME_TOTAL_VENDEDOR_RowCommand" OnRowDataBound="G_INFORME_TOTAL_VENDEDOR_RowDataBound" runat="server"
                                                                ...
                                                                DataKeyNames="id, coddocumento, cod_trans, estado, nombre_trans, codbodega"
                                                                Font-Size="12px">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Quitar">
                                                                        <ItemTemplate>
                                                                            <asp:ImageButton ID="B_desplani" runat="server" ImageUrl="img/delete.png" Width="25"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Completar">
                                                                        <ItemTemplate>
                                                                            <asp:ImageButton ID="B_enviar" runat="server" ImageUrl="img/accept.png" Width="25"
                                                                    ...
                                                                    <asp:BoundField DataField="nombre_trans" HeaderText="NomTransporte">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="text-center" />
                                                                        <ItemStyle HorizontalAlign="Center" />

                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="disponible_camion" HeaderText="DisponibleCamion">
                                                                        <HeaderStyle HorizontalAlign="Center" CssClass="text-center" />
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    </asp:BoundField>
                                        ...
                                        <div class="box">
                                            <div class="form-group" style="display: block">
                                                ...
                                                <div class="col-sm-12 col-lg-12">
                                                    ...
                                                    <asp:GridView ID="G_DETALLE_PLANI" CssClass="table table-bordered" OnRowDataBound="G_DETALLE_PLANI_RowDataBound" runat="server" Visible="true"
                                                        ShowHeaderWhenEmpty="True" DataKeyNames="" Font-Size="12px">
                                                        <HeaderStyle CssClass="test no-sort" />
                                                        <Columns>
                                                        </Columns>
                                                        <EmptyDataTemplate>
                                        ...
                                        <div class="box">
                                            <div class="form-group" style="display: block">
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    <label>Para: </label>
                                                    <div class="controls">
                                                        <asp:TextBox runat="server" class="form-control" ID="tx_para"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <textarea runat="server" id="tx_text_" class="form-control" placeholder="Contenido" rows="2"></textarea>
                                            ...
                                            <asp:Button runat="server" class="btn btn-success" Text="Enviar" OnClick="Unnamed_Click" OnClientClick="CARGANDO_ENVIAR();"></asp:Button>
